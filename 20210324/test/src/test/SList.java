...
public class SList<E> {
	public static void main(String[] args) {
		...
		SList<Float> f = new SList<Float>();
		f.insertFront((float)3.1); f.insertFront((float)2.2);
		f.insertAfter((float)7.7, f.head);
		f.print();
	}
	...
	public int search(E target) { // target을 찾아 위치k 반환
		Node p = head;
	...
	public void print() { // 노드의 모든 요소 출력 (탭으로 구분)
